...
*/
        ...
        add(ModBlocks.GOLDEN_BOX.get(), "金匣");
        add(ModBlocks.JUNGLE_BOX.get(), "丛林匣");
        add(ModBlocks.SKY_BOX.get(), "天空匣");
        add(ModBlocks.CORRUPT_BOX.get(), "腐化匣");
        add(ModBlocks.TR_CRIMSON_BOX.get(), "猩红匣");
        add(ModBlocks.SACRED_BOX.get(), "神圣匣");
        add(ModBlocks.DUNGEON_BOX.get(), "地牢匣");
        add(ModBlocks.FREEZE_BOX.get(), "冰冻匣");
        add(ModBlocks.OASIS_BOX.get(), "绿洲匣");
        add(ModBlocks.OBSIDIAN_BOX.get(), "黑曜石匣");
        add(ModBlocks.OCEAN_BOX.get(), "海洋匣");
        add(ModBlocks.PEARLWOOD_BOX.get(), "珍珠木匣");
        add(ModBlocks.MITHRIL_BOX.get(), "秘银匣");
        add(ModBlocks.TITANIUM_BOX.get(), "钛金匣");
        add(ModBlocks.THORNS_BOX.get(), "荆棘匣");
        add(ModBlocks.SPACE_BOX.get(), "太空匣");
        add(ModBlocks.DEFACED_BOX.get(), "污损匣");
        add(ModBlocks.BLOOD_BOX.get(), "血匣");
        add(ModBlocks.PROVIDENTIAL_BOX.get(), "天赐匣");
        add(ModBlocks.FENCING_BOX.get(), "围栏匣");
        add(ModBlocks.CONIFEROUS_WOOD_BOX.get(), "针叶木匣");
        add(ModBlocks.ILLUSION_BOX.get(), "幻象匣");
...
/*
        ...
        */
        ...
        add(Arrows.FLAMING_ARROW.get(), "烈焰箭");
        add(Arrows.UNHOLY_ARROW.get(), "邪箭");
        add(Arrows.JESTERS_ARROW.get(), "小丑之箭");
        add(Arrows.HELLFIRE_ARROW.get(), "狱炎箭");
        add(Arrows.FROSTBURN_ARROW.get(), "寒霜箭");
        add(Arrows.BONE_ARROW.get(), "骨箭");
        add(Arrows.SHIMMER_ARROW.get(), "微光箭");
