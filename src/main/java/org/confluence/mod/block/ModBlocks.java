...
public final class ModBlocks {
    ...
    //雪泥块
    public static final RegistryObject<Block> DESERT_FOSSIL = registerWithItem("desert_fossil", () -> new Block(BlockBehaviour.Properties.copy(Blocks.SANDSTONE)));
    ...
    public static final RegistryObject<Block> EBONY_SANDSTONE = registerWithItem("ebony_sandstone", () -> new SpreadingFixedBlock(ISpreadable.Type.CORRUPT, BlockBehaviour.Properties.of()));
    public static final RegistryObject<Block> EBONY_HARDENED_SAND_BLOCK = registerWithItem("ebony_hardened_sand_block", () -> new SpreadingFixedBlock(ISpreadable.Type.CORRUPT, BlockBehaviour.Properties.of()));
    ...
    public static final RegistryObject<Block> PEARL_HARDENED_SAND_BLOCK = registerWithItem("pearl_hardened_sand_block", () -> new SpreadingFixedBlock(ISpreadable.Type.HALLOW, BlockBehaviour.Properties.of()));
    public static final RegistryObject<Block> PEARL_SANDSTONE = registerWithItem("pearl_sandstone", () -> new SpreadingFixedBlock(ISpreadable.Type.HALLOW, BlockBehaviour.Properties.of()));
    ...
    public static final RegistryObject<Block> ANOTHER_CRIMSON_HARDENED_SAND_BLOCK = registerWithItem("another_crimson_hardened_sand_block", () -> new SpreadingFixedBlock(ISpreadable.Type.CRIMSON, BlockBehaviour.Properties.of()));
    public static final RegistryObject<Block> ANOTHER_CRIMSON_SANDSTONE = registerWithItem("another_crimson_sandstone", () -> new SpreadingFixedBlock(ISpreadable.Type.CRIMSON, BlockBehaviour.Properties.of()));
