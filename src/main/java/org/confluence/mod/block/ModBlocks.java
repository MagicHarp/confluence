...
import org.confluence.mod.block.crafting.*;
...
public final class ModBlocks {
    ...
    public static final RegistryObject<Block> AMBER_SAPLING = registerWithItem("amber_sapling", () -> new StoneSaplingBlock(new AmberTreeGrower(), BlockBehaviour.Properties.copy(Blocks.OAK_SAPLING)));
    public static final RegistryObject<Block> TOPAZ_SAPLING = registerWithItem("topaz_sapling", () -> new StoneSaplingBlock(new TopazTreeGrower(), BlockBehaviour.Properties.copy(Blocks.OAK_SAPLING)));
    public static final RegistryObject<Block> EMERALD_SAPLING = registerWithItem("emerald_sapling", () -> new StoneSaplingBlock(new EmeraldTreeGrower(), BlockBehaviour.Properties.copy(Blocks.OAK_SAPLING)));
    public static final RegistryObject<Block> DIAMOND_SAPLING = registerWithItem("diamond_sapling", () -> new StoneSaplingBlock(new DiamondTreeGrower(), BlockBehaviour.Properties.copy(Blocks.OAK_SAPLING)));
    ...
    public static final RegistryObject<Block> BIG_TR_EMERALD_BLOCK = registerWithItem("big_tr_emerald_block", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE_BRICKS)));
    ...
    public static final RegistryObject<SkyMillBlock> SKY_MILL = registerWithItem("sky_mill", SkyMillBlock::new, supplier -> () -> new SkyMillBlock.Item(supplier.get()));
    ...
    public static final RegistryObject<AlchemyTableBlock> ALCHEMY_TABLE_BLOCK = registerWithItem("alchemy_table", AlchemyTableBlock::new);
    public static final RegistryObject<BlockEntityType<AlchemyTableBlock.Entity>> ALCHEMY_TABLE_BLOCK_ENTITY = BLOCK_ENTITIES.register("alchemy_table_entity", () -> BlockEntityType.Builder.of(AlchemyTableBlock.Entity::new, ALCHEMY_TABLE_BLOCK.get()).build(null));
    // fluid
    ...
    public static final RegistryObject<Block> FLOATING_WHEAT_BALE = registerWithItem("floating_wheat_bale", FloatingWheatBaleBlock::new);
    // 草药
