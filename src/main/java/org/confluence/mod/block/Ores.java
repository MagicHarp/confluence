...
public enum Ores implements EnumRegister<Block> {
    ...
    //红玉矿
    RUBY_ORE("ruby_ore", MeteoriteOre::new),
    DEEPSLATE_RUBY_ORE("deepslate_ruby_ore", MeteoriteOre::new),
    //黄玉矿
    TOPAZ_ORE("topaz_ore", MeteoriteOre::new),
    DEEPSLATE_TOPAZ_ORE("deepslate_topaz_ore", MeteoriteOre::new),
    //琥珀矿
    AMBER_ORE("amber_ore", MeteoriteOre::new),
    DEEPSLATE_AMBER_ORE("deepslate_amber_ore", MeteoriteOre::new),
    //异域紫晶矿
    ANOTHER_AMETHYST_ORE("another_amethyst_ore", MeteoriteOre::new),
    DEEPSLATE_ANOTHER_AMETHYST_ORE("deepslate_another_amethyst_ore", MeteoriteOre::new),
    //蓝玉矿
    SAPPHIRE_ORE("sapphire_ore", MeteoriteOre::new),
    DEEPSLATE_SAPPHIRE_ORE("deepslate_sapphire_ore", MeteoriteOre::new),
    // 魔矿
