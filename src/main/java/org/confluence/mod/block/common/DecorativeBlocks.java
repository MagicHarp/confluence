...
public enum DecorativeBlocks implements EnumRegister<Block> {
    TR_OAK_BEAM("another_oak_beam", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS))),
    TR_OAK_PLANKS("another_oak_planks", () -> new BeamLikeBlock(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS))),
    TR_NORTHLAND_BEAM("another_northland_beam", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS))),
    TR_NORTHLAND_PLANKS("another_northland_planks", () -> new BeamLikeBlock(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS))),
    ...
    TR_STONE_BRICKS("another_stone_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE_BRICKS))),
    TR_COPPER_BRICKS("another_copper_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.COPPER_BLOCK))),
    ANCIENT_COPPER_BRICKS("ancient_copper_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.COPPER_BLOCK))),
    TR_COPPER_PLATE("another_copper_plate", () -> new BeamLikeBlock(BlockBehaviour.Properties.copy(Blocks.COPPER_BLOCK))),
    ...
    TR_IRON_BRICKS("another_iron_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK))),
    ...
    TR_GOLD_BRICKS("another_gold_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK))),
    ...
    TR_CRIMSON_ORE_BRICKS("another_crimson_ore_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK))),
    TR_CRIMSON_ROCK_BRICKS("another_crimson_rock_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK))),
    ...
    TR_LAVA_BEAM("another_lava_beam", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE_BRICKS))),
    TR_LAVA_BRICKS("another_lava_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE_BRICKS))),
    TR_OBSIDIAN_BEAM("another_obsidian_beam", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE_BRICKS))),
    TR_OBSIDIAN_BRICKS("another_obsidian_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE_BRICKS))),
    TR_OBSIDIAN_PLATE("another_obsidian_plate", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE_BRICKS))),
    TR_OBSIDIAN_SMALL_BRICKS("another_obsidian_small_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE_BRICKS))),
    TR_SMOOTH_OBSIDIAN("another_smooth_obsidian", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE_BRICKS))),
    TR_GRANITE_COLUMN("another_granite_column", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE_BRICKS))),
    MARBLE_COLUMN("marble_column", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE_BRICKS))),

    CHISELED_TR_OBSIDIAN_BRICKS("chiseled_another_obsidian_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE_BRICKS))),
