 ...
 */
public interface EnumBlockRegister<B extends Block> extends EnumRegister<B> {
    // 各类预设
    ...
    EnumBlockRegister.BlockTagsHolder COMPONENT_TIER_9_TOOL = new BlockTagsHolder(ModTags.Blocks.NEEDS_9_LEVEL);
    // 矿物预设
    ...
    EnumBlockRegister.BlockTagsHolder TAGS_ORE_TIER_9_TOOL = new BlockTagsHolder(TAGS_ORE_BASIC, COMPONENT_TIER_9_TOOL);
