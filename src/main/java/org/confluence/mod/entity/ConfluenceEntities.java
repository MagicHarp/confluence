...
public class ConfluenceEntities {
    ...
    public static final RegistryObject<EntityType<BaseSlime>> BLUE_SLIME = registerSlime("blue", ConfluenceParticles.ITEM_BLUE_GEL, 2);
    public static final RegistryObject<EntityType<BaseSlime>> GREEN_SLIME = registerSlime("green", ConfluenceParticles.ITEM_BLUE_GEL, 2);
    public static final RegistryObject<EntityType<BaseSlime>> PINK_SLIME = registerSlime("pink", ConfluenceParticles.ITEM_PINK_GEL, 1);
    public static final RegistryObject<EntityType<BaseSlime>> CORRUPTED_SLIME = registerSlime("corrupted", ConfluenceParticles.ITEM_BLUE_GEL, 2);
    public static final RegistryObject<EntityType<BaseSlime>> DESERT_SLIME = registerSlime("desert", ConfluenceParticles.ITEM_BLUE_GEL, 2);
    public static final RegistryObject<EntityType<BaseSlime>> EVIL_SLIME = registerSlime("evil", ConfluenceParticles.ITEM_BLUE_GEL, 2);
    public static final RegistryObject<EntityType<BaseSlime>> ICE_SLIME = registerSlime("ice", ConfluenceParticles.ITEM_FROZEN_GEL, 2);
    public static final RegistryObject<EntityType<BaseSlime>> LAVA_SLIME = registerSlime("lava", ConfluenceParticles.ITEM_BLUE_GEL, 2);
    public static final RegistryObject<EntityType<BaseSlime>> LUMINOUS_SLIME = registerSlime("luminous", ConfluenceParticles.ITEM_BLUE_GEL, 2);
    public static final RegistryObject<EntityType<BaseSlime>> CRIMSON_SLIME = registerSlime("crimson", ConfluenceParticles.ITEM_BLUE_GEL, 2);
    public static final RegistryObject<EntityType<BaseSlime>> PURPLE_SLIME = registerSlime("purple", ConfluenceParticles.ITEM_BLUE_GEL, 2);
    public static final RegistryObject<EntityType<BaseSlime>> RED_SLIME = registerSlime("red", ConfluenceParticles.ITEM_BLUE_GEL, 2);
    public static final RegistryObject<EntityType<BaseSlime>> TROPIC_SLIME = registerSlime("tropic", ConfluenceParticles.ITEM_BLUE_GEL, 2);
    public static final RegistryObject<EntityType<BaseSlime>> YELLOW_SLIME = registerSlime("yellow", ConfluenceParticles.ITEM_BLUE_GEL, 2);
    /* todo honey slime  */
