...
public class ModChineseProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("item.confluence.amphibian_boots.info", "水陆两用靴是一种配饰，可由旗鱼靴和蛙腿在工作台处制作而来。");
        add("item.confluence.amphibian_boots.info2", "装备它具有以下效果：");
        add("item.confluence.amphibian_boots.info3", "将玩家的最大移动速度提高到 22.5 米/秒（31 英里/小时）");
        add("item.confluence.amphibian_boots.info4", "允许自动跳跃");
        add("item.confluence.amphibian_boots.info5", "最大安全坠落距离增加 10 米");
        add("item.confluence.amphibian_boots.info6", "跳跃速度提高 1.6");
        ...
        add("item.confluence.blizzard_in_a_balloon.info", "它使跳跃高度提高 33%，跳跃速度提高 30%，将第一次跳跃的高度提高到 ~10½ 格（增加 ~75%），并提供双跳，现在达到 14½ 格，总高度为 25 格。");
        ...
        add("item.confluence.blizzard_in_a_bottole.info2", "暴风瓶跳跃上升到空中 8 米，与第一次跳跃放在一起时总共 14 米。 ");
        add("item.confluence.blizzard_in_a_bottole.info3", "它可以在工作台处用云朵瓶和蓝冰制作。");
        add("item.confluence.blue_horseshoe_balloon.info", "蓝色马蹄气球是一种配饰，可以免疫坠落伤害，增加 75% 的跳跃高度，提供二段跳，并提供 +0.05 的幸运。");
        add("item.confluence.blue_horseshoe_balloon.info2", "第一跳的高度从 6 个方块增加到 10.5 个方块，而二段跳的高度从 5 个方块增加到 9 个方块，两次跳跃总共达到 19.5 个方块。");
        add("item.confluence.blue_horseshoe_balloon.info3", "它可以在工作台处用云朵气球和幸运马掌制作。");
        add("item.confluence.bundle_of_balloons.info", "气球束是一种配饰，可让佩戴者进行四段跳，并将玩家的跳跃持续时间增加 33%，跳跃速度增加 30%。");
        ...
        add("item.confluence.bundle_of_horseshoe_balloons.info2", "装备后，玩家可以进行四段跳，并将玩家的跳跃持续时间增加 33%，跳跃速度增加 30%，运气增加 0.05%。");
        ...
        add("item.confluence.cloud_in_a_balloon.info2", "它使跳跃高度提高 33%，跳跃速度提高 30%，将玩家第一次跳跃的高度增加到 10.5 格（增加 ~75%），并提供击中 9 个方块的双跳，总高度为 19.5 个方块。");
        ...
        add("item.confluence.cloud_in_a_bottle.info3", "与普通跳跃相比，额外的跳跃持续时间为 75%，将玩家在没有其他配件的情况下可以达到的最大高度增加了 5 米，总共 11 米。");
        add("item.confluence.dunerider_boots.info", "沙丘行者靴是一种可以提高玩家最大移动速度的配饰");
        add("item.confluence.dunerider_boots.info2", "它有几率从尸壳中掉落。");
        add("item.confluence.dunerider_boots.info3", "装备它具有以下效果：");
        add("item.confluence.dunerider_boots.info4", "玩家的最大移动速度提高到22.5 米/秒");
        add("item.confluence.dunerider_boots.info5", "在任何沙子、砂岩或硬化沙子上移动时，最大移动速度分别提高 15%，加速和减速分别增加 75%");
        ...
        add("item.confluence.fart_in_a_balloon.info2", "它使跳跃高度提高 33%，跳跃速度提高 30%，将玩家第一次跳跃的高度提高到 ~10.5 格（增加 ~75%），并提供两次跳跃，达到 18.5 格，总共 29 格。");
        ...
        add("item.confluence.fart_in_a_jar.info2", "放屁跳升空 10.5 米，与第一次跳合在一起总共 16.5 米。");
        add("item.confluence.fart_in_a_jar.info3", "这些效果也适用于装备的翅膀。");
        ...
        add("item.confluence.flurry_boots.info2", "装备后，它们允许玩家在连续奔跑一定距离后获得速度提升。");
        add("item.confluence.frog_flipper.info", "青蛙脚蹼是由蛙腿和脚蹼在工作台上制成的配饰。");
        add("item.confluence.frog_flipper.info2", "它结合了这两个项目的能力，增加了玩家的跳跃速度和安全坠落距离，允许自动跳跃，并赋予玩家游泳的能力。");
        add("item.confluence.frog_leg.info", "蛙腿有几率从青蛙掉落。");
        add("item.confluence.frog_leg.info2", "蛙腿是一种配饰，可以在任何可行的水体中钓鱼。它通过以下方式帮助跳跃：");
        add("item.confluence.frog_leg.info3", "玩家的跳跃速度提高1.6");
        add("item.confluence.frog_leg.info4", "玩家在按住跳跃键时自动跳跃。");
        add("item.confluence.frog_leg.info5", "此效果也适用于攀岩爪和其他攀爬配件。");
        add("item.confluence.frog_leg.info6", "最大安全坠落距离增加 10");
        add("item.confluence.frog_leg.info7", "这些效果也适用于装备的翅膀。");
        add("item.confluence.frostspark_boots.info", "霜花靴是将闪电靴和溜冰鞋组合在工作台上制作的配饰。");
        add("item.confluence.frostspark_boots.info2", "它提供了两者的效果。");
        add("item.confluence.frostspark_boots.info3", "它们提供的移动速度加成也提高了 8%。");
        add("item.confluence.green_horseshoe_balloon.info", "绿马蹄气球是一个配饰，可以免疫坠落伤害，增加33%的跳跃高度，增加30%的跳跃速度，提供二段跳，并给予+0.05点幸运。");
        add("item.confluence.green_horseshoe_balloon.info2", "第一跳的高度从 6 个方块增加到 10.5 个方块（~增加 75%），而双跳的高度从 10.5 个方块增加到 18.5 个方块，两次跳跃总共达到 29 个方块。");
        ...
        add("item.confluence.hermes_boots.info3", "速度将继续增加，直到达到最大速度。在全速冲刺时，它们会将玩家的水平移动速度提高到 30 英里/小时。");
        add("item.confluence.hermes_boots.info4", "但是，如果玩家在没有自动跳跃的情况下撞到墙上，玩家将停下来，不得不再次加速。");
        add("item.confluence.honey_balloon.info", "蜂蜜气球是一款结合了闪亮红色气球和蜂窝功能的配件。");
        add("item.confluence.honey_balloon.info2", "它使跳跃高度提高 33%，跳跃速度提高 30%，将你的第一次跳跃高度提高到 ~10½ 格（增加 ~75%），并在玩家受伤时释放一小群愤怒的蜜蜂，它们会寻找并对敌人造成少量伤害。");
        ...
        add("item.confluence.lava_waders.info", "熔岩靴是一种配饰，允许玩家在所有液体的表面上行走，包括水、蜂蜜、微光甚至熔岩，而不会受到熔岩伤害或触发着火！debuff（与水上行走靴和黑曜石水上行走靴不同，它们只允许在水和蜂蜜上行走）。");
        add("item.confluence.lava_waders.info2", "熔岩靴还允许玩家安全地浸入熔岩中 7 秒（按向下键潜入），而不会受到熔岩伤害或触发着火！debuff。");
        ...
        add("item.confluence.lava_waders.info5", "它还将熔岩的基础伤害从 80 降低到 35。");
        ...
        add("item.confluence.lightning_boots.info2", "与幽灵靴相比，它们有 8% 的移动速度加成。");
        ...
        add("item.confluence.magiluminescence.info", "魔光护符是困难模式前的配饰，可将玩家的最大移动速度提高 15%，将玩家的加速和减速提高 75%。");
        ...
        add("item.confluence.molten_charm.info2", "熔火护身符还可以免疫通常因接触陨石、狱石和狱石砖而造成的燃烧伤害。");
        ...
        add("item.confluence.obsidian_horseshoe.info2", "它对陨石、狱石和狱石砖造成的燃烧伤害给予免疫，抵消坠落伤害并给予+0.05点幸运。");
        ...
        add("item.confluence.obsidian_water_walking_boots.info2", "它们允许佩戴者在水、蜂蜜和微光上行走，同时还对燃烧减益免疫。");
        ...
        add("item.confluence.pink_horseshoe_balloon.info", "粉红马蹄气球是一个配饰，可以免疫坠落伤害，增加33%的跳跃高度和30%的跳跃速度，提供二段跳，并给予+0.05的运气。");
        add("item.confluence.pink_horseshoe_balloon.info2", "第一跳的高度从 6 个方块增加到 10.5 个方块（~75% 增加），而双跳的高度从 7 个方块增加到 13 个方块，两次跳跃总共达到 23.5 个方块。");
        ...
        add("item.confluence.rocket_boots.info4", "如果还装备了云朵瓶，其二段跳效果将首先生效;之后在半空中按住跳跃键将激活火箭靴。");
        ...
        add("item.confluence.sailfish_boots.info4", "通过向一个方向奔跑，玩家的移动速度会增加多达40%。");
        ...
        add("item.confluence.sandstorm_in_a_balloon.info3", "它使跳跃高度提高33%，跳跃速度提高30%，将玩家第一次跳跃的高度提高到10.5米，并提供可以达到26.5米高度的双跳，总高度为37米。");
        add("item.confluence.sandstorm_in_a_bottle.info", "沙暴瓶是一种配饰，可以在沙漠神殿的宝箱中找到。");
        add("item.confluence.sandstorm_in_a_bottle.info2", "它类似于云朵瓶，提供了一个二段跳，允许一些额外的高度，但脚下不是云，而是出现一个沙暴流，角色在跳跃上上升时在视觉上旋转。");
        add("item.confluence.sandstorm_in_a_bottle.info3", "沙暴跳跃上升到空中 15 米，与第一次跳跃放在一起时总共 21 米。");
        add("item.confluence.sandstorm_in_a_bottle.info4", "这几乎是云朵瓶所能达到的高度的两倍。");
        add("item.confluence.sharkron_balloon.info", "鲨鱼龙气球是一个结合了海啸瓶和气球河豚鱼效果的配饰。");
        add("item.confluence.sharkron_balloon.info2", "它将跳跃高度提高 33%，跳跃速度提高 30%，将第一次跳跃的高度提高到 ~10.5 格（增加 ~75%），并提供现在 13 格的双跳，总高度为 23.5 格。");
        add("item.confluence.shiny_red_balloon.info", "闪亮红气球是一个配饰，可以将玩家的跳跃高度提高 33%，将跳跃速度提高 30%，将玩家可以跳跃的高度从 6 个方块（12 英尺）增加到 ~10.5个方块（21 英尺），有效地提升了 ~75%。然而，奇怪的是，它在水下时会降低跳跃高度，从 8 个方块（16 英尺）降低到 ~7 个方块（14 英尺）。");
        add("item.confluence.shiny_red_balloon.info2", "当玩家拥有村庄英雄效果时，图书管理员有几率将此物品交给玩家。");
        add("item.confluence.shiny_red_balloon.info3", "闪亮红气球与其他跳跃增强配件叠加：");
        add("item.confluence.shiny_red_balloon.info4", "云朵瓶的二段跳高度从 5 个方块（10 英尺）增加到 9 个方块（18 英尺），总跳跃高度为 19.5 个方块（39 英尺）。");
        add("item.confluence.shiny_red_balloon.info5", "暴雪瓶的二段跳高度从 8 个方块（16 英尺）增加到 14.5个方块（29 英尺），总跳跃高度为 25 个方块（50 英尺）。");
        add("item.confluence.shiny_red_balloon.info6", "沙暴瓶的二段跳高度从 14.5 格（29 英尺）增加到 26.5 格（53 英尺），总跳跃高度为 37 格（74 英尺）。");
        add("item.confluence.shiny_red_balloon.info7", "罐中臭屁的二段跳高度从 101.5 块（21 英尺）增加到 18.5 块（37 英尺），总跳跃高度为 29 块（58 英尺）。");
        add("item.confluence.shiny_red_balloon.info8", "海啸瓶的二段跳高度从 7 个方块（14 英尺）增加到 12 个方块（24 英尺），总跳跃高度为 231/2 个方块（47 英尺）。");
        add("item.confluence.shiny_red_balloon.info9", "使用火箭/幽灵靴，飞行速度会加快，使相同的飞行时间将玩家带到更高和/或更远的地方。");
        add("item.confluence.shiny_red_balloon.info10", "蛙腿跳跃加成与闪亮红气球加成叠加，让第一次跳跃达到 16.5 格（33 英尺）。");
        add("item.confluence.shiny_red_balloon.info11", "有了翅膀，飞行时间就会增加。");
        add("item.confluence.shiny_red_balloon.info12", "但是，蜂蜜气球和气球河豚鱼不会与闪亮红气球叠加;他们都给予相同的好处。");
        add("item.confluence.spectre_boots.info", "幽灵靴是由 火箭靴 和 疾风雪靴、赫尔墨斯靴、沙丘行者靴或 旗鱼靴制成的配饰，并结合了它们的功能。");
        add("item.confluence.spectre_boots.info2", "在飞行过程中，它们会发出白色/蓝色的云迹，但与火箭靴不同的是，它们不会产生任何光。它们的飞行时间约为 1.6 秒，与火箭靴相同。");
        ...
        add("item.confluence.tsunami_in_a_bottle.info3", "海啸跳跃上升到空中 7 米，与第一次跳跃放在一起时总共 13 米。");
        ...
        add("item.confluence.water_walking_boots.info3", "他们不允许在熔岩上行走。当玩家在液体上时，他们可能会按下 Down 从液体中掉落，类似于平台。");
        add("item.confluence.water_walking_boots.info4", "它可以在海洋废墟宝箱中找到。");
        add("item.confluence.white_horseshoe_balloon.info", "白马掌气球是一个配饰，可以免疫坠落伤害，增加33%的跳跃高度和30%的跳跃速度，提供二段跳，并给予+0.05的运气。");
        add("item.confluence.white_horseshoe_balloon.info2", "第一跳的高度从 6 个方块增加到 10.5 个方块（~增加 75%），而二段跳的高度从 8 个方块增加到 14.5 个方块，两次跳跃总共达到 25 个方块。");
        add("item.confluence.white_horseshoe_balloon.info3", "它可以在工作台处用暴雪瓶和闪亮红气球制作。");
        add("item.confluence.yellow_horseshoe_balloon.info", "黄马掌气球是一个配饰，可以免疫坠落伤害，增加75%的跳跃高度，提供二段跳，并给予+0.05的运气。");
        add("item.confluence.yellow_horseshoe_balloon.info2", "第一跳的高度从 6 个方块增加到 10.5 个方块，而双跳的高度从 15 个方块增加到 26.5 个方块，两次跳跃总共达到 37 个方块。");
        ...
        add("item.confluence.sun_stone.info9", "+0.5 仆从击退");
