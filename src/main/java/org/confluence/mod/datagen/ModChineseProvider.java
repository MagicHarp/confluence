...
public class ModChineseProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(Jars.FOREST_JARS.get(), "森林陶罐");
        add(Jars.SNOW_JARS.get(), "雪地陶罐");
        add(Jars.SPIDER_CAVE_JARS.get(), "蛛洞陶罐");
        add(Jars.DESERT_JARS.get(), "沙漠陶罐");
        add(Jars.JUNGLE_JARS.get(), "丛林陶罐");
        add(Jars.MARBLE_JARS.get(), "尘封陶罐");
        add(Jars.PYRAMID_JARS.get(), "祭祀陶罐");
        add(Jars.CORRUPT_JARS.get(), "蠕虫陶罐");
        add(Jars.ANOTHER_CRIMSON_JARS.get(), "血肉陶罐");
        add(Jars.DUNGEON_JARS.get(), "地牢陶罐");
        add(Jars.ASH_JARS.get(), "炎烬陶罐");
        add(Jars.TEMPLE_JARS.get(), "神庙陶罐");
        ...
        add(TerraPotions.MAGC_POWER_POTION.get(), "魔能药水");
