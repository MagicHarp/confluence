...
public class ModEnglishProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("item.confluence.metal_detector.info","The Metal Detector is an informational accessory that detects valuable objects, including ores, chests, Life Crystals, and Life Fruit, within a rectangular area of 170×125 tiles centered on the player.");
        ...
        add("item.confluence.radar.info","The Radar is an informational accessory which displays the number of nearby enemies in a 125-tile radius around the player.");
