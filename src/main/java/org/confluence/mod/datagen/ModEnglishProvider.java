...
public class ModEnglishProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("item.confluence.dps_meter.info","The Fisherman's Pocket Guide is an informational accessory that displays the player's current Fishing Power. The Fisherman's Pocket Guide can be received as a 1/34 (2.94%)[1] chance reward for completing a fishing quest for the Angler NPC, depending on the number of completed quests and other factors (for details, see Angler).");
        add("item.confluence.dps_meter.info2","The Fisherman's Pocket Guide is one of the three parts necessary to make the Fish Finder, with the others being the Sextant and the Weather Radio, and as such is a required ingredient in crafting the Shellphone.");
        ...
        add("item.confluence.goblin_tech.info","The GPS is an informational accessory that enables an on-screen display of the player's current depth, lateral position, and time.");
