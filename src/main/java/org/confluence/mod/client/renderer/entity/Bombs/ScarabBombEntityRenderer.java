...
public class ScarabBombEntityRenderer extends EntityRenderer<ScarabBombEntity> {
    ...
    @Override
    public void render(ScarabBombEntity entity, float entityYaw, float partialTick, PoseStack poseStack, @NotNull MultiBufferSource multiBufferSource, int packedLight) {
        poseStack.pushPose();
