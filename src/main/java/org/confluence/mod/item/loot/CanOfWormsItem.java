...
public class CanOfWormsItem extends Item {
    public CanOfWormsItem() {
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(@NotNull Level level, @NotNull Player player, @NotNull InteractionHand hand) {
        ...
        if (level instanceof ServerLevel serverLevel && hand == InteractionHand.MAIN_HAND) {
            ...
            LootTable loottable = serverLevel.getServer().getLootData().getLootTable(ModLootTables.CAN_OF_WORMS);
