...
public class StarCannonItem extends AbstractGunItem {
    public StarCannonItem() {
    ...
    public void initializeClient(@NotNull Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private DefaultGunItemRenderer<StarCannonItem> renderer;

            @Override
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (renderer == null) {
                    this.renderer = new DefaultGunItemRenderer<>("starcannon");
                }
                return renderer;
            }
