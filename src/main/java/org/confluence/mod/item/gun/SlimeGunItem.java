...
public class SlimeGunItem extends AbstractGunItem {
    public SlimeGunItem() {
    ...
    public void initializeClient(@NotNull Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private DefaultGunItemRenderer<SlimeGunItem> renderer;

            @Override
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (renderer == null) {
                    this.renderer = new DefaultGunItemRenderer<>("slimegun");
                }
                return renderer;
            }
