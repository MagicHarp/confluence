...
public class TacticalShotgunItem extends AbstractGunItem {
    public TacticalShotgunItem() {
    ...
    public void initializeClient(@NotNull Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private DefaultGunItemRenderer<TacticalShotgunItem> renderer;

            @Override
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (renderer == null) {
                    this.renderer = new DefaultGunItemRenderer<>("tacticalshotgun");
                }
                return renderer;
            }
