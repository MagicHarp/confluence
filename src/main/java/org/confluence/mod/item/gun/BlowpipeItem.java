...
public class BlowpipeItem extends AbstractGunItem {
    public BlowpipeItem() {
    ...
    public void initializeClient(@NotNull Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private DefaultGunItemRenderer<BlowpipeItem> renderer;

            @Override
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (renderer == null) {
                    this.renderer = new DefaultGunItemRenderer<>("blowpipe");
                }
                return renderer;
            }
