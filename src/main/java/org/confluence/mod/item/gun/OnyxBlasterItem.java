...
public class OnyxBlasterItem extends AbstractGunItem {
    public OnyxBlasterItem() {
    ...
    public void initializeClient(@NotNull Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private DefaultGunItemRenderer<OnyxBlasterItem> renderer;

            @Override
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (renderer == null) {
                    this.renderer = new DefaultGunItemRenderer<>("onyxblaster");
                }
                return renderer;
            }
