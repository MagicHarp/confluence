...
public class PlatinumArmorItem extends ArmorItem implements NormalGeoItem {
    private final AnimatableInstanceCache PLATINUM = GeckoLibUtil.createInstanceCache(this);
