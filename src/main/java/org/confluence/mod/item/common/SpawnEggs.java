...
public enum SpawnEggs implements EnumRegister<ForgeSpawnEggItem> {
    BLUE_SLIME_SPAWN_EGG("blue_slime_spawn_egg", ModEntities.BLUE_SLIME, 0x66CCFF, 0x466CBE),
    PURPLE_SLIME_SPAWN_EGG("purple_slime_spawn_egg", ModEntities.PURPLE_SLIME, 0x9B119E, 0xA246BE),
    GREEN_SLIME_SPAWN_EGG("green_slime_spawn_egg", ModEntities.GREEN_SLIME, 0xE3C929, 0xCBB31E),
    RED_SLIME_SPAWN_EGG("red_slime_spawn_egg", ModEntities.RED_SLIME, 0xC91717, 0xA51E1E),
    YELLOW_SLIME_SPAWN_EGG("yellow_slime_spawn_egg", ModEntities.YELLOW_SLIME, 0xCAEE70, 0x8DEE70),
    BLACK_SLIME_SPAWN_EGG("black_slime_spawn_egg", ModEntities.BLACK_SLIME, 0x7E7E7E, 0x373535),
    PINK_SLIME_SPAWN_EGG("pink_slime_spawn_egg", ModEntities.PINK_SLIME, 0xFF87B3, 0xDD427B),
    ...
    TROPIC_SLIME_SPAWN_EGG("tropic_slime_spawn_egg", ModEntities.TROPIC_SLIME, 0x3F69BB, 0x2B6B5B),
