...
public enum Materials implements EnumRegister<Item> {
    ...
    BLINKROOT_GAINS("blinkroot_gains", () -> new BaseItem(WHITE)),
    DAYBLOOM_POLLEN("daybloom_pollen", () -> new BaseItem(WHITE)),
    DEATHWEED_FLESH("deathweed_flesh", () -> new BaseItem(WHITE)),
    MOONGLOW_PETAL("moonglow_petal", () -> new BaseItem(WHITE)),
