...
public enum Materials implements EnumRegister<Item> {
    ...
    FROSTY_MINNOW("frosty_minnow"),
    PISCES_FIN_COD("pisces_fin_cod"),
    PARTIAL_MOUTH_FISH("partial_mouth_fish"),
    ...
    NEON_GREASE_CARP("neon_grease_carp"),
    DAMSEL_FISH("damsel_fish"),
    EBONY_KOI("ebony_koi"),
    SCARLET_TIGER_FISH("scarlet_tiger_fish"),
    BLOODY_PIRANHAS("bloody_piranhas"),
    PRINCESS_FISH("princess_fish"),
    COLORFUL_MINERAL_FISH("colorful_mineral_fish"),
    CHAOS_FISH("chaos_fish"),
    MOTTLED_OILFISH("mottled_oilfish"),
    GOLDEN_CARP("golden_carp"),
    OBSIDIAN_FISH("obsidian_fish"),
    FLASHFIN_KOI("flashfin_koi"),
