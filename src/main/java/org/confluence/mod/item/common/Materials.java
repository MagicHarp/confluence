...
public enum Materials implements EnumRegister<Item> {
    ...
    RAW_TR_CRIMSON("raw_another_crimson", () -> new BaseItem(BLUE)),
    TR_CRIMSON_INGOT("another_crimson_ingot", () -> new BaseItem(BLUE)),
    ...
    TR_AMETHYST("another_amethyst", () -> new BaseItem(WHITE)),
