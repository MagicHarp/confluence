...
public enum Materials implements EnumRegister<Item> {
    ...
    HALLOWED_INGOT("hallowed_ingot", () -> new BaseItem(LIGHT_RED)),
    CHLOROPHYTE_INGOT("chlorophyte_ingot", () -> new BaseItem(ORANGE)),
    RAW_CHLOROPHYTE("raw_chlorophyte", () -> new BaseItem(ORANGE)),
    SHROOMITE_INGOT("shroomite_ingot", () -> new BaseItem(ORANGE)),
    SPECTRE_INGOT("spectre_ingot", () -> new BaseItem(ORANGE)),
